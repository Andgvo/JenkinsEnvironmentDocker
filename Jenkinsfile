pipeline {
    ...
    stages {
        ...
        //             sh "docker login -u $USERNAME -p $PASSWORD 192.168.3.19:8083"
        //             sh "docker tag microservicio:latest 192.168.3.19:8083/repository/docker-private/microservicio:latest"
        //             sh "docker push 192.168.3.19:8083/repository/docker-private/microservicio:latest"
        //         }
        //     }
        // }
        ...
        stage('Deploy Service') {
            steps {
                withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_nexus', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                    ...
                    sh 'docker run -d --rm --name microservicio -e SPRING_PROFILES_ACTIVE=dev -p 8090:8090 192.168.3.19:8083/repository/docker-private/microservicio:latest'
                }
            }
        }
